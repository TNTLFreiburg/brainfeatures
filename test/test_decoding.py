...
from brainfeatures.decoding.decode import validate, final_evaluate, \
    get_cropped_train_test, decode_once, apply_pca, apply_scaler, get_train_test
...
def test_get_train_test():
    ...
    X_train, y_train, X_test, y_test = \
        get_train_test(X, y, train_ind, test_ind)
    ...
    X_train, y_train, X_test, y_test, train_groups, test_groups = \
        get_cropped_train_test(X, y, train_ind, test_ind, epoch_to_group_map)
